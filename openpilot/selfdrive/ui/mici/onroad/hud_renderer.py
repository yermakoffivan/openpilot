...
class HudRenderer(Widget):
  def __init__(self):
    ...
    self._txt_chestnut: rl.Texture = gui_app.texture('icons_mici/egpu.png', 60, 44)
    self._txt_chestnut_green: rl.Texture = gui_app.texture('icons_mici/egpu_green.png', 60, 44)
    self._txt_chestnut_orange: rl.Texture = gui_app.texture('icons_mici/egpu_orange.png', 60, 44)
  ...
  def _draw_model_source(self, rect: rl.Rectangle) -> None:
    ...
    alpha = self._chestnut_alpha_filter.update(loading or 0 < rl.get_time() - self._chestnut_fade_time < SET_SPEED_PERSISTENCE)
    if alpha < 1e-2:
      return
